...
import LaboratoryContext from 'src/context/laboratory/laboratoryContext';
import { LABORATORIO, MEDICO } from 'src/utils/role';
...
const Laboratory = () => {
  ...
  return (
    <Page className={classes.root} title="Laboratorio">
