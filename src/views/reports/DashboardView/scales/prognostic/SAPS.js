...
const APACHE = ({
  ...
  const calculateApache = values => {
    ...
    const newValue = (glasgow - 15) * -1;

    value = glasgow < 4 ? (value += 12) : newValue;
        ...
        <PerfectScrollbar>
          <Box height={400}>
            <Table>
              ...
              <TableBody>
                {data.apaches.map(saps => (
                  <TableRowCustom hover key={apache._id}>
                    <TableCellCustom>
                      {moment(saps.date).format('DD/MM/YYYY')}
                    </TableCellCustom>
                    <TableCellCustom>
                      {saps.breathing_frequency}
                    </TableCellCustom>
                    <TableCellCustom>{saps.o2_saturation}</TableCellCustom>
                    <TableCellCustom>{saps.epoc ? 'SI' : 'NO'}</TableCellCustom>
                    <TableCellCustom>
                      {saps.supplemental_oxygen ? 'SI' : 'NO'}
                    </TableCellCustom>
                    <TableCellCustom>
                      {saps.systolic_blood_pressure}
                    </TableCellCustom>
                    <TableCellCustom>{saps.heart_rate}</TableCellCustom>
                    <TableCellCustom>
                      {saps.conscience_level ? 'CVDI' : 'ALERTA'}
                    </TableCellCustom>
                    <TableCellCustom>{saps.temperature}</TableCellCustom>
                    <TableCellCustom>
                      <Chip color="primary" label={saps.value} />
                    </TableCellCustom>
                  </TableRowCustom>
                ))}
              </TableBody>
